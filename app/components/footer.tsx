...
export default function Footer() {
  return (
    <>
      {/* DESKTOP */}
      <main
        className={`hidden xl:flex flex-col pt-[70px] xl:pt-[100px] pb-[60px] px-[26px] lg:px-[52px] justify-center items-center w-full bg-purple-betz max-w-[1920px] shadow-inner ${pixeBoy.className}`}
      >
      ...
      {/* MOBILE */}
      <main
        className={`flex xl:hidden flex-col pt-[70px] xl:pt-[100px] pb-[60px] px-[26px] lg:px-[52px] justify-center items-center w-full bg-purple-betz max-w-[1920px] shadow-inner ${pixeBoy.className}`}
      >
        <div className="flex flex-col w-full max-w-[1920px] gap-4">
          <div className="flex flex-col justify-between items-center border-b border-jugz-light/50 pb-[20px] w-full px-[10px] text-jugz-light text-sm xl:text-xl">
          ...
          <div className="flex flex-row justify-center items-center w-full px-[10px] text-jugz-light">
            <div className="flex flex-row items-center gap-5">
              <Link
                href="https://x.com/juggernauts_io"
                className="hover:opacity-75"
